...
async function handleMessage(msg, sender) {
  ...
  switch (msg.action) {
    ...
    case 'profile_sync_unlock': { await browser.storage.local.set({ [PROFILE_SYNC_KEYS.enabled]: true }); const state = await profileSync.unlock(String(msg.password || ''), !!msg.create); await providerManager.load(); return { ok: true, ...state }; }

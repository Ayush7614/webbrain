...
export default {
  ...
  'st.display.tracing.desc_html': 'Simpan setiap larian (permintaan LLM, respons, panggilan alat, tangkapan skrin) ke dalam IndexedDB tempatan supaya anda boleh memeriksa dan membandingkan model secara bersebelahan. Dibuka dalam tab Jejak yang berasingan. Dihidupkan secara lalai untuk memudahkan penyahpepijatan tempatan; anda boleh mematikannya di sini pada bila-bila masa. <a href="traces.html" target="_blank" style="color:var(--accent);">Buka halaman Jejak →</a>',

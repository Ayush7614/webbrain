...
export default {
  ...
  'st.display.tracing.desc_html': 'حفظ كل تشغيل (طلبات LLM، الاستجابات، استدعاءات الأدوات، لقطات الشاشة) في IndexedDB المحلية حتى تتمكّن من فحص النماذج ومقارنتها جنبًا إلى جنب. يُفتح في علامة تبويب «التتبّعات» منفصلة. مُفعَّل افتراضيًا لتسهيل تصحيح الأخطاء محليًا، ويمكنك إيقافه هنا في أي وقت. <a href="traces.html" target="_blank" style="color:var(--accent);">افتح صفحة التتبّعات →</a>',

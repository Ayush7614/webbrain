...
export default {
  ...
  'st.display.tracing.desc_html': 'Guarda cada ejecución (peticiones al LLM, respuestas, llamadas a herramientas, capturas) en IndexedDB local para que puedas inspeccionar y comparar modelos lado a lado. Se abre en una pestaña de Trazas aparte. Activado por defecto para facilitar la depuración local; puedes desactivarlo aquí en cualquier momento. <a href="traces.html" target="_blank" style="color:var(--accent);">Abrir página de Trazas →</a>',

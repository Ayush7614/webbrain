...
export default {
  ...
  'st.display.tracing.desc_html': '将每次运行（LLM 请求、响应、工具调用、截图）持久化到本地 IndexedDB，以便并排查看和对比模型。在独立的轨迹页打开。为方便本地调试，默认开启；你可以随时在此关闭。<a href="traces.html" target="_blank" style="color:var(--accent);">打开轨迹页 →</a>',

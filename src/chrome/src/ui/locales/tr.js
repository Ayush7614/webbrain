...
export default {
  ...
  'st.display.tracing.desc_html': 'Her çalışmayı (LLM istekleri, yanıtlar, araç çağrıları, ekran görüntüleri) yerel IndexedDB\'de saklar, böylece modelleri yan yana inceleyip karşılaştırabilirsin. Ayrı bir İzler sekmesinde açılır. Yerel hata ayıklamayı kolaylaştırmak için varsayılan olarak açıktır; buradan istediğin zaman kapatabilirsin. <a href="traces.html" target="_blank" style="color:var(--accent);">İzler sayfasını aç →</a>',
